...
const EditProduct = ({editProduct, render, setEditProduct}) => {
    ...
    useEffect(() => {
        ...
        setPayload({description: typeof editProduct?.description === 'object' ? editProduct?.description?.join(', ') 
    ...
    useEffect(() => {
        // Check kiểu mảng của images có phải là FileList không
    ...
    const handleFileSelected = (e) => {
      ...
      setPreview({...preview, images: [...preview.images, file] });
    };
    ...
    <div className='w-full flex flex-col gap-4 relative'>
        ...
        <div className='p-4 border-b flex bg-gray-500 justify-between right-0 left-[327px] items-center fixed top-0'>
          ...
          <form onSubmit={handleSubmit(handleUpdateProduct)}>
              ...
              {preview.images.length > 0 && <div className='my-4 flex w-full gap-3 flex-wrap'>
                {preview.images?.map((el, idx)=> (
                  ...
                  >
                      <img src={el} alt='images product' className='w-[200px] object-contain' />  
                  </div>
                ))}
              </div>}
